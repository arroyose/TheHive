...
<html lang="en">
<?php
    require ("$path/DAO/DAO_comunidades.php");
?>
<head>
    <meta charset="utf-8" />
        ...
        <div id="content-region" class="content region">
            ...
            <div class="container" id="botoneraCentral">
                <h2 class="title-color text-center">Panel de administración</h2>
                    ...
                    <div class="row">
                        <a href="administracion/adminComunidades.php">
                            <div class="col-xs-12 col-sm-6 col-md-2 menuUsuario botonActivo" id="btn_comunidades">
                                    <h6>Comunidades</h6>
                                    <i class="fas fa-city"></i> 
                            </div>
                        </a>

                        <a href="administracion/adminFincas.php" class="botonera">
                        ...
                        <a href="administracion/adminResidentes.php" class="botonera">
                        ...
                        <a href="administracion/adminJuntas.php" class="botonera">
                            <div class="col-xs-12 col-sm-6 col-md-2 menuUsuario" id="btn_juntas">
                                    <h6>Juntas</h6>
                                    <i class="fas fa-handshake"></i> 
                            </div>
                        </a>
                        <a href="administracion/adminContabilidad.php" class="botonera">
                            <div class="col-xs-12 col-sm-6 col-md-2 menuUsuario" id="btn_contabilidad">
                                    <h6>Contabilidad</h6>
                                    <i class="fas fa-file-invoice-dollar"></i>
                            </div>
                        </a>
                        <a href="administracion/adminOtros.php" class="botonera">
            ...
            <div class="row">
                <div class="container area_trabajo text-center" id="areaTrabajo">
                    <h2 class="title-color">Mis Comunidades</h2>
                    <h4>Esta es el area de trabajo</h4>
                    <div class="container">
                    <?php
                    $comunidad=new DAO_comunidades();
                    echo $comunidad->comunidadesPorAdministrador(1);
                    ?>
                    </div>
                </div>  
